  ...
  public static function exceptionMessages($errorCode, $errorMessage, $reasons=null) {
    ...
    switch ($errorCode) {
      ...
      case 66504:
        ...
        break;
      case 66510:
        $exception['exception'] = __('In order to use the Authorize.net Gateway, you must enter your API Login ID and Transaction Key in the Cart66 Settings Panel', 'cart66');
        break;
      case 66511:
        $exception['exception'] = __('In order to use the Authorize.net AIM Emulation gateway, you must enter your emulation URL in the Cart66 Settings Panel', 'cart66');
        break;
      case 66520:
        $exception['exception'] = __('In order to use the PayLeap Gateway, you must enter your API Username and Transaction Key in the Cart66 Settings Panel', 'cart66');
        break;
      case 66530:
        $exception['exception'] = __('In order to use the eWay Gateway, you must enter your Customer ID in the Cart66 Settings Panel', 'cart66');
        break;
      case 66540:
        $exception['exception'] = __('In order to use the Merchant Warrior Gateway, you must enter your Merchant Warrior API Passphrase, MerchantUUID and API Key in the Cart66 Settings Panel', 'cart66');
        break;
      case 66600:
